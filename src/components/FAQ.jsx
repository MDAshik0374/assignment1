  ...
  return (
          ...
          <div className="mb-12 flex lg:mb-[70px]">
            <div
              className="mr-4 flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xl bg-primary text-white sm:mr-6 sm:h-[60px] sm:max-w-[60px]">
               <FaqSVG width="32" height= "32" viewBox="0 0 34 34" className="fill-current" path={pathArray}/>
            </div>
    ...
    <div>
      <span className="absolute left-4 top-4 -z-[1]">
        <FaqSVG2 width="48" height="134" viewBox="0 0 48 134" fill="none" xmlns="http://www.w3.org/2000/svg"/>
      </span>
      <span className="absolute bottom-4 right-4 -z-[1]">
        <FaqSVG3 width="48" height="134" viewBox="0 0 48 134" fill="none" xmlns="http://www.w3.org/2000/svg" />
