...
import AboutSvg1 from "./SVGS/AboutSvg1";
import AboutSvg2 from "./SVGS/AboutSvg2";
import AboutSvg3 from "./SVGS/AboutSvg3";
            ...
            <div className="-mx-2 flex flex-wrap sm:-mx-4 lg:-mx-2 xl:-mx-4">
              <div className="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                <div className="mb-4 sm:mb-8 sm:h-[400px] md:h-[540px] lg:h-[400px] xl:h-[500px]">
                  <img src="/src/assets/images/about/about-image-01.jpg" alt="about image"
              ...
              <div className="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                <div className="mb-4 sm:mb-8 sm:h-[220px] md:h-[346px] lg:mb-4 lg:h-[225px] xl:mb-8 xl:h-[310px]">
                  <img src="/src/assets/images/about/about-image-02.jpg" alt="about image"
                    className="h-full w-full object-cover object-center" />
                </div>
                ...
                <div
                  ...
                  <div>
                    <span className="absolute left-0 top-0 -z-10">
                        <AboutSvg1 width="106" height="144" viewBox="0 0 106 144" fill="none" xmlns="http://www.w3.org/2000/svg"/>
                    ...
                    <span className="absolute right-0 top-0 -z-10">
                        <AboutSvg2 width="130" height="97" viewBox="0 0 130 97" fill="none" xmlns="http://www.w3.org/2000/svg"/>
                    ...
                    <span className="absolute bottom-0 right-0 -z-10">
                        <AboutSvg3 width="175" height="104" viewBox="0 0 175 104" fill="none"
                        xmlns="http://www.w3.org/2000/svg"/>
