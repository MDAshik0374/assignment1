        ...
        <div className="w-full px-4">
          <div className=" relative z-10 mx-auto max-w-[845px]">
            ...
            <div className="absolute -left-9 bottom-0 z-[-1]">
              <HeroSvg1 width="134" height="106" viewBox="0 0 134 106" fill="none" xmlns="http://www.w3.org/2000/svg" />  
            </div>
            <div className="absolute -right-6 -top-6 z-[-1]">
              <HeroSvg2 width="134" height="106" viewBox="0 0 134 106" fill="none" xmlns="http://www.w3.org/2000/svg"/>
